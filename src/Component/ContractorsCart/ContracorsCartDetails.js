    ...
    <div className="p-5 lg:p-14 mt-10 bg-[#FFF] rounded-2xl ">
      <div className="flex justify-between">
        ...
        <div className="lg:flex md:flex ">
          <div className="lg:mr-4 md:mr-3">
            <p className="mb-1 text-sm lg:text-lg md:text-lg ">STATUS</p>
            <div className="flex rounded-full bg-[#3F8825] lg:w-40 lg:justify-between p-1 lg:p-2 md:w-36 w-28 md:p-2 ">
              <button className="lg:mr-6 text-[#FFFFFF]">Unverified </button>
              <img src={arow1} alt="" />
            </div>
          </div>
          <div>
            <p className="mb-1 text-sm lg:text-lg md:text-lg">ACCOUNT</p>
            <div className="flex rounded-full bg-[#3F8825] lg:w-40 lg:justify-between p-1 md:w-36 lg:p-2 md:p-2 w-28">
              <button className="lg:mr-6 text-[#FFFFFF]">Active </button>
      ...
      <div className=" lg:mx-28 md:mx-12 mt-7">
        ...
        <div className="mt-4 flex ">
            ...
            <div className="bg-[#E5EBE4] p-2 w-32 flex rounded-full items-center justify-between">
